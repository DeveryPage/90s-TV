...
namespace NinetiesTV
{
    class Program
    {
        ...
        **************************************************************************************************/
        ...
        static List<string> ShowsByPopularity(List<Show> shows)
        {
        ...
        static List<string> ShowsWithAmpersand(List<Show> shows)
        {
            return shows.Where(s => s.Name.Contains("&")).Select(s => s.Name).ToList();
        }
        ...
        static List<string> TheShows(List<Show> shows)
        {
            return shows.Where(s => s.Name.StartsWith("The")).Select(s => s.Name).ToList();
        }

        // 10. Return all shows except for the lowest rated show.
        static List<Show> AllButWorst(List<Show> shows)
        {
            return shows.Select(s => s).OrderBy(s => s.ImdbRating).Skip(1).ToList();
        }
        ...
        {
            return shows.Where(s => s.Genres.Contains("Comedy")).OrderBy(shows => shows.ImdbRating).Select(s => s.Name).ToList();
        }
        ...
        {
            return shows.Where(s => s.Genres.Contains("Drama")).OrderByDescending(s => s.ImdbRating)
        }
